...
object Main {
  ...
  def main(args: scala.Array[String]): Unit = {
    ...
    //   (store, action) =>
    //     console.log("reducing action:", store.toString, action)
    //     action(store)
    // }
    ...
    //     clicked
    // }
    // val todoFooter = todoCount &> todoFilterAll &> todoFilterActive
    // render(
    //   div(todoHeader &> todoList &> todoCount, Var(List("todoapp"))),
